      ...
      <div className="md:w-1/4 w-full bg-foreground h-screen">
        ...
        <div className="flex justify-between p-5 items-center align-middle">
          ...
          <div className=" text-white">
            <h1 className=" font-bold uppercase text-xl">CampCon</h1>
          </div>

          {/* addpeople and notifications */}
          <div className="flex gap-2">
            <div className="p-2 bg-white w-max rounded-full">
        ...
        <div className="px-5">
          <div className="relative">
            ...
            <Input
              type="text"
              placeholder="Search"
              className="bg-primary pl-10 pr-2 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
        </div>
...
<div className="bg-background w-full h-screen md:flex flex-col hidden">
  ...
  <div className="pt-5 px-5 flex items-center justify-between">
    <div className="flex justify-center items-center gap-10">
      ...
      <Link href="/profile" className="flex bg-foreground px-8 py-2 text-white rounded-3xl justify-between gap-4 text-xl font-bold items-center">
        <Avatar className="inline-block">
          <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
          <AvatarFallback>CN</AvatarFallback>
        </Avatar>
...
:
<h1 className=" text-6xl font-extrabold text-center  text-white md:flex hidden justify-center items-center w-full">welcome</h1>
}
    </div>
  );
};
